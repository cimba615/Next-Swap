...
function LayoutSwitcher() {
  ...
  function handleLayout(selectedLayout: string) {
    ...
    if (layout === LAYOUT_OPTIONS.MODERN)
      URLSegments.splice(1, 0, String(selectedLayout));
    else if (selectedLayout === LAYOUT_OPTIONS.MODERN) URLSegments.splice(1, 1);
    else URLSegments.splice(1, 1, String(selectedLayout));
